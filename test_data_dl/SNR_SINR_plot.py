...
n_s = 4
dir_1 = ab_path+'/test_data/4_stream_ptrl/UE_4_UAV_4'
dir_2 = ab_path+'/test_data/dedicated_2_2_ptrl'
...
df1_sinr, df1_snr, df1_inr = get_df(dir_ = dir_1, n = 4, f= 28)
df1_sinr_uav, df1_snr_uav, df1_inr_uav = get_df(dir_ = dir_1, n = 4, ground= False, f = 28)

df2_sinr,df2_snr, df2_inr= get_df(dir_ = dir_2, n= 2, f= 28)
df2_sinr_uav,df2_snr_uav, df2_inr_uav = get_df(dir_ = dir_2, n= 2, ground= False, f =28)
